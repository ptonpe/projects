...
def shortest_path(source, target):
    ...
    """
    #keeps track of how many nodes explored
    num_explored = 0
    ...
    while True:
        ...
        #mark actor as explored 
        explored.add(node.state)
        
        #find neighbors of the actor (people to which he can connect to)
        ...
        for movie, actor in neighbors:
            if actor not in explored and not frontier.contains_state(actor):
                ...
                if child.state == target:
                    #return list of tuples (movie id, actor id)
                    path = []
                    node = child

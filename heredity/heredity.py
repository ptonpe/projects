...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        gene_numb_probab = PROBS['gene'][gene_number]
        trait_probab = PROBS['trait'][gene_number][trait]

        if people[person]['mother'] is None:
            #no parents so distribute
            probability *= gene_numb_probab * trait_probab

        else:
            #parents info available
